...
def get_active_number():
    return jsonify({'active_number': active_number})
...
def set_active_number():
    ...
    return jsonify({'status': 'success', 'active_number': active_number})
...
def verify_passcode():
    ...
    if inputcode==passcode :
        ...
        active_number = data.get('number', 0)
        return jsonify({'status': 'success','success':True, 'active_number': active_number})
    else:
